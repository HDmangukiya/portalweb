...
public class slideshow_service_ implements slideshow_service {
  ...
  @Autowired slideshow_mapper slideshowMapper;

  @Autowired image_service imageService;
  ...
  @Override
  public boolean update_slideshow(
      String image_path_url_new, String image_path_url_old, String image_information) {
    ...
    return slideshowMapper.update_slideshow(
        image_path_url_new, image_path_url_old, image_information);
  }
